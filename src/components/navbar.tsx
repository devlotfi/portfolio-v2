...
export default function Navbar() {
  ...
  return (
    <div className="flex relative justify-between items-center min-h-[5rem] px-[1rem]">
      ...
      <motion.div
        className="bg-background-light-100 dark:bg-background-dark-100 card-outline-light dark:card-outline-dark !outline-[0.3rem] rounded-full p-[0.3rem] space-x-2 hidden lg:flex absolute left-1/2 -translate-x-1/2"
        initial="hidden"
        animate="visible"
        transition={{
          delayChildren: 2.5,
